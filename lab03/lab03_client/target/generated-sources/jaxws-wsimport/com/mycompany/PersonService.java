 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://mycompany.com/", wsdlLocation = "http://localhost:8080/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://mycompany.com/", "PersonService");
